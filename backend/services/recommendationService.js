...
class RecommendationService {
    constructor() {
        ...
        this.moduleCorrelations = {
            M1: [0.2, 1, 0.1, 0.1, 0.3], // AI, IS, CS, CN, SE
            M2: [0.4, 0.2, 1, 0.3, 0.4],
            M3: [0.8, 0.4, 0.3, 0.2, 0.2],
            M4: [0.8, 0.4, 0.3, 0.2, 0.2],
            M5: [0.2, 0.3, 0.2, 0.6, 1],
            M6: [0.4, 0.4, 0.3, 0.4, 1],
            M7: [0.1, 0.5, 0.4, 0.5, 0.6],
            M8: [1, 0.7, 0.4, 0.1, 0.1],
            M9: [0.2, 0.2, 0.2, 1, 0.5],
            M10: [0.2, 0.4, 1, 0.5, 0.3]
        };
